...
public class QualityAssuranceManagerWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form QualityAssuranceManagerWorkAreaJPanel
     */
    ...
    public QualityAssuranceManagerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, QualityAssuranceCenter organization, Enterprise enterprise, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quality Assurance Manager ");

        btnManageTechnician.setBackground(new java.awt.Color(255, 255, 102));
        btnManageTechnician.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        btnManageTechnician.setForeground(new java.awt.Color(51, 51, 255));
        btnManageTechnician.setText("Manage Technician");
        btnManageTechnician.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnUserAccount.setBackground(new java.awt.Color(255, 255, 102));
        btnUserAccount.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        btnUserAccount.setForeground(new java.awt.Color(51, 51, 255));
        btnUserAccount.setText("Manage User Account");
        btnUserAccount.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnWorkQueue.setBackground(new java.awt.Color(255, 255, 102));
        btnWorkQueue.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        btnWorkQueue.setForeground(new java.awt.Color(51, 51, 255));
        btnWorkQueue.setText("Manage Work Queue");
        btnWorkQueue.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
