...
public class LogisticManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public LogisticManagerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Logistics organization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
...
//        System.out.println(organization.getName() + "Hai mera naam");
    ...
    private void initComponents() {
        ...
        btnDriver.setBackground(new java.awt.Color(255, 255, 102));
        btnDriver.setFont(new java.awt.Font("Lucida Calligraphy", 0, 12)); // NOI18N
        btnDriver.setForeground(new java.awt.Color(51, 51, 255));
        ...
        btnUserAccount.setForeground(new java.awt.Color(0, 51, 255));
