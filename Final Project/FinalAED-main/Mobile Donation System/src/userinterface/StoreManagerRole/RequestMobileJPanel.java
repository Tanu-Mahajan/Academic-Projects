...
//        populatestoreTable();
    ...
    private void initComponents() {
        ...
        tblStores.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        ...
        quantityTxt.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        ...
        add(quantityTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 290, 123, -1));

        requestBtn.setBackground(new java.awt.Color(255, 255, 102));
        requestBtn.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        requestBtn.setText("Request");
        requestBtn.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        requestBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                requestBtnActionPerformed(evt);
            }
        });
        add(requestBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 290, -1, -1));

        btnRequestInventory.setBackground(new java.awt.Color(255, 255, 102));
        btnRequestInventory.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        btnRequestInventory.setText("Request Inventory");
        btnRequestInventory.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnRequestInventory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRequestInventoryActionPerformed(evt);
            }
        });
        add(btnRequestInventory, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 290, -1, -1));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 540, -1, -1));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Request Mobile");
