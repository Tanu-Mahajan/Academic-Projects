...
public class StoreWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblStore.setBackground(new java.awt.Color(204, 204, 204));
        tblStore.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        ...
        btnRequestLaptop.setBackground(new java.awt.Color(242, 242, 242));
        btnRequestLaptop.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        btnRequestLaptop.setText("Request Laptop");
        btnRequestLaptop.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        txtGiveAway.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btnGiveAway.setBackground(new java.awt.Color(153, 255, 153));
        ...
        btnDailySub.setBackground(new java.awt.Color(102, 255, 255));
        ...
        jLabel4.setText("Store Work Area");
    ...
    private void btnRequestLaptopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestLaptopActionPerformed
        ...
        userProcessContainer.add("RequestLaptopJPanel", new RequestMobileJPanel(userProcessContainer, userAccount, organization, enterprise, business, network));
